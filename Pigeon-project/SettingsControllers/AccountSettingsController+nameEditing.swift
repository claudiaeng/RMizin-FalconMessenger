...
extension AccountSettingsController: UITextViewDelegate {
  ...
  func estimateFrameForText(_ text: String, width: CGFloat) -> CGRect {
    ...
    return NSString(string: text).boundingRect(with: size, options: options, attributes: [NSAttributedString.Key.font: UIFont(name: "Avenir-Book", size: 14)], context: nil).integral
  }
